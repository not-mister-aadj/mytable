...
const dataFile = join(process.cwd(), "emails", "icon-data.ts");
...
for (const [name, svg] of Object.entries(icons)) {
  ...
  base64Entries.push([name, png.toString("base64")]);
  console.log(`OK: ${name}.png`);
}

const dataTs = [
  "// Generated by scripts/generate-email-icons.mjs — do not edit manually.",
  "export const emailIconPngBase64 = {",
  ...base64Entries.map(([name, b64]) => `  ${name}: "${b64}",`),
  "} as const;",
  "",
  "export type EmailIconDataName = keyof typeof emailIconPngBase64;",
  "",
].join("\n");

await writeFile(dataFile, dataTs);
console.log("OK: emails/icon-data.ts");
