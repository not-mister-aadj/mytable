...
import { sampleSundayTableWaitlistWelcomeProps } from "@/emails/sample-data";
import { requireAdmin } from "@/lib/admin-auth";
import { sundayTableWaitlistWelcomeSubject } from "@/lib/email/subjects";

export default async function SundayTableWaitlistWelcomeEmailPreviewPage() {
  await requireAdmin();
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="font-serif text-2xl text-burgundy">
            E-mail preview · Wachtlijst welkom
          </h1>
