...
export const memberClubNl: MemberClubLabels = {
  ...
  hero: {
    ...
    line: "Hier maak je culinaire vrienden elke eerste zondag van de maand.",
    memberLine: "Hier maak je culinaire vrienden elke eerste zondag van de maand.",
    cta: "Claim je plek",
    secondaryCta: "Wat is Clubmember",
  },
  tableFilter: {
  ...
  happening: {
    ...
    filterCities: "Steden",
    filterTables: "Tafel",
    seatsGoingFast: "6–10 plekken gaan snel",
    seatsLeftFew: "Nog {count} plekken over",
  ...
  paywall: {
    ...
    summary: "{price}/maand",
    promoCodeLabel: "Kortingscode",
    promoCodePlaceholder: "Code",
    promoCodeHint: "Alleen geldig op de 1 maand trial.",
    promoCodeApply: "Toepassen",
    promoCodeApplying: "Bezig…",
    promoCodeApplied: "Toegepast",
    promoCodeRemove: "Verwijderen",
    promoCodeInvalid: "Deze kortingscode is ongeldig of verlopen.",
    promoCodeTrialOnly: "Kortingscodes gelden alleen voor de 1 maand trial.",
    promoCodeAppliedLine: "{code} · Bespaar {percent} → nu {final}",
