...
export const sundayTableLpEn: SundayTableLpLabels = {
  ...
  heroBenefits: [
    ...
    {
      bold: "Girls only or mixed table",
  ...
  sale: {
    bar: "Up to 80% off in our WhatsApp group",
    barMobile: "Up to 80% off via WhatsApp",
    eyebrow: "Try-out discount",
    title: "Up to 80% off your first month",
    body: "Join the WhatsApp group. Discount codes, and you're always first for a seat before the table fills up.",
    girlsOnly: "Girls only group",
    girlsOnlyHint: "Women only",
    mixed: "Mixed group",
    mixedHint: "Everyone welcome",
    close: "Close",
    dialogAria: "Claim WhatsApp discount",
  },
  how: {
    eyebrow: "Clubmember",
  ...
  pricing: {
    ...
    popularLabel: "5 months",
    popularPrice: "€50",
    popularHint: "€10/month · most chosen",
    yearLabel: "12 months",
    yearPrice: "€100",
    yearHint: "€8.33/month",
    justification:
