 ...
 * buildWaitlistLabelsEn() in build-waitlist-labels.ts, overriding only the
 * few lines that mention "table" specifically. */
export const sundayTableWaitlistEn: SundayTableLpLabels["waitlist"] = {
  eyebrow: "Waitlist",
  ...
  errorCity: "Please choose at least one city.",
...
export const sundayTableLpEn: SundayTableLpLabels = {
  ...
  waitlist: sundayTableWaitlistEn,
};
