...
export const sundayTableLpNl: SundayTableLpLabels = {
  ...
  sale: {
    ...
    barMobile: "TRY-OUT: 80% korting via WhatsApp",
    eyebrow: "Try-out Sale",
    title: "80% korting op je eerste maand",
    body: "Join de WhatsApp-groep die bij je past. Daar staat de exclusieve code.",
