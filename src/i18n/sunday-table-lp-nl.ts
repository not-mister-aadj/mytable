...
export const sundayTableWaitlistNl: SundayTableLpLabels["waitlist"] = {
  ...
  errorName: "Vul je voornaam in.",
  errorEmail: "Vul een geldig e-mailadres in.",
  errorCity: "Kies minstens één stad.",
  ...
  how: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Zodra we een tafel hebben die aansluit bij wat jij zoekt, hoor je van ons.",
      },
      {
        title: "Claim je plek",
  ...
  included: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Vul de tafel met je eigen groep, of laat je matchen met nieuwe mensen. Jij kiest.",
      },
      {
        title: "MyTable aanraders",
        body: "De leukste cafés, restaurants en wijnbars van de stad, door ons uitgezocht.",
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Nee hoor, de meeste mensen komen gewoon solo. Je zit dus in goed gezelschap.",
      },
      {
        question: "Wat kost het?",
        answer:
          "Zodra er een tafel voor je klaarstaat, hoor je de prijs. Op de wachtlijst staan is gratis en verplicht je tot niets.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Dat verschilt per stad en tafeltype. We nodigen mensen met de hand uit zodra we een tafel hebben die bij je past.",
      },
    ],
  },
